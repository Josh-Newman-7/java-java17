...
public class Stream_05_Test {
    ...
    public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum() {
        Logger.getAnonymousLogger().info("imperativeSum => " + imperativeSum(NB) + " ms");
        Logger.getAnonymousLogger().info("iterateSum => " + iterateSum(NB) + " ms");
        Logger.getAnonymousLogger().info("parallelIterateSum => " + parallelIterateSum(NB) + " ms");
    }
    ...
    public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum_vs_rangeSum_vs_rangeParallelSum() {
        ...
        Logger.getAnonymousLogger().info("iterateSum => " + iterateSum(NB) + " ms");
        Logger.getAnonymousLogger().info("parallelIterateSum => " + parallelIterateSum(NB) + " ms");
        Logger.getAnonymousLogger().info("rangeSum => " + rangeSum(NB) + " ms");
        Logger.getAnonymousLogger().info("rangeParallelSum => " + rangeParallelSum(NB) + " ms");
    }
