...
public class Function_04_Test {
    ...
    public void test_predicate() throws Exception {
        ...
        List<Person> result = filter(personList, person -> adult.test(person));
    ...
    public void test_predicate_and() throws Exception {
        ...
        List<Person> result = filter(personList, person -> adult.test(person) && lastnameIsFrance.test(person) && firstnameIsArmor.test(person));
